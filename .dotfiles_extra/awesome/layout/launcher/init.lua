...
local args = {
	...
	save_history = true,
	background = beautiful.bg_color .. "A7",
	...
	prompt_icon_markup = helpers.colorize_text("", beautiful.text),
	prompt_text_color = beautiful.text,
	prompt_cursor_color = beautiful.text,
	apps_per_column = 1,
	apps_per_row = 6,
	app_icon_halign = "left",
	app_selected_color = beautiful.bg_2,
	app_normal_color = beautiful.bg_color,
	app_name_normal_color = beautiful.text,
	app_name_selected_color = beautiful.bg_color,
	app_name_selected_color = beautiful.text,
