...
local playing_or = wibox.widget({
	...
	markup = helpers.colorize_text("Now playing", beautiful.text .. "99"),
...
local song_artist = wibox.widget({
	widget = wibox.widget.textbox,
	markup = helpers.colorize_text("Unknown", beautiful.text .. "99"),
...
local song_name = wibox.widget({
	widget = wibox.widget.textbox,
	markup = helpers.colorize_text("None", beautiful.text),
...
playerctl:connect_signal("metadata", function(_, title, artist, album_path, _, _, _)
	...
	song_artist:set_markup_silently(helpers.colorize_text(artist, beautiful.text))
end)
