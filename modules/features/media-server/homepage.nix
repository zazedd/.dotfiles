  ...
  flake.modules.nixos.mediaserver =
    { config, ... }:
    {
      ...
      services.glance = {
        ...
        settings = {
          server = {
            port = config.registry.home.port;
          };
          pages = [
            {
              name = "Home";
...

                {
                  ...
                  widgets = [
                    ...
                    }
                    {
                      ...
                      title = "Services";
                      sites =
                        map (mkSite config.domain) [
                          "jellyfin"
                          "radarr"
                          "sonarr"
                        ]
                        ++ map (mkSiteNoIcon config.domain) [
                          "bazarr"
                          "jellyseerr"
                          "prowlarr"
                          "cloud"
...

                    {
                      ...
                      cache = "5m";
                      url = "https://jellyfin.${config.domain}/Users/\${JELLYFIN_USER_ID}/Items";
                      parameters = {
                      ...
                      subrequests = {
                        user = {
                          url = "https://jellyfin.${config.domain}/Users/\${JELLYFIN_USER_ID}";
                          parameters = {
                            api_key = "\${JELLYFIN_KEY}";
                          };
                        };
