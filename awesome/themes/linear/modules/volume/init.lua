local wp = require("themes.linear.modules.volume.wireplumber")
...
local widget = wibox.widget({
    {
        ...
        {
            id = "icon",
            markup = helper.color_text_icon("  ", "#7a9ff5", "10"),
...
local update_widget_icon = function()
    awful.spawn.easy_async_with_shell([[wpctl get-volume @DEFAULT_AUDIO_SINK@]], function(stdout)
        ...
        widget.iconbg.icon:set_markup(helper.color_text_icon(icon, "#62b2de", "18"))
    end)
end
